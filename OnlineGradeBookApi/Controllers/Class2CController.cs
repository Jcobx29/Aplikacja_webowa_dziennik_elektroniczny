...
public class Class2CController : ControllerBase
{
    private readonly IStudentsService _studentsService;
        ...
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2C",1);
            return Ok(model);
        }
        [HttpPost]
        public IActionResult BiologyAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2C",1);
            return Ok(model);
        }
        [HttpGet]
        public IActionResult ChemistryAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2C", 2);
            return Ok(model);
        }
        [HttpPost]
        public IActionResult ChemistryAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2C", 2);
            return Ok(model);
        }
        [HttpGet]
        public IActionResult EnglishAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2C", 3);
            return Ok(model);
        }
        [HttpPost]
        public IActionResult EnglishAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2C", 3);
            return Ok(model);
        }
        [HttpGet]
        public IActionResult GeographyAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2C",4);
            return Ok(model);
        }
        [HttpPost]
        public IActionResult GeographyAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2C", 4);
            return Ok(model);
        }
        [HttpGet]
        public IActionResult GermanAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2C", 5);
            return Ok(model);
        }
        [HttpPost]
        public IActionResult GermanAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2C", 5);
            return Ok(model);
        }
        [HttpGet]
        public IActionResult HistoryAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2C", 6);
            return Ok(model);
        }
        [HttpPost]
        public IActionResult HistoryAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2C", 6);
            return Ok(model);
        }
        [HttpGet]
        public IActionResult MathAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2C", 7);
            return Ok(model);
        }
        [HttpPost]
