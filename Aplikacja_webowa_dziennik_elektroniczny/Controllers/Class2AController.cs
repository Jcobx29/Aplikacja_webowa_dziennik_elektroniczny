...
{
    [Authorize(Roles = "Student2A, BiologyTeacher, ChemistryTeacher, EnglishTeacher, GeographyTeacher, GermanTeacher, HistoryTeacher, MathTeacher, HeadTeacher")]
    public class Class2AController : Controller
    {
        private readonly IStudentsService _studentsService;
        public Class2AController(IStudentsService studentsService)
        {
        ...
        {
            var model = _studentsService.GetAllStudentsForList(10, 1, "2A");
            return View(model);
        }
        [HttpPost]
        public IActionResult Index(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllStudentsForList(pageSize, pageNo.Value, "2A");
            return View(model);
        }
        [HttpGet]
        public IActionResult StudentsContactInformation()
        {
            var model = _studentsService.GetAllStudentsContanctInfoForList(10, 1, "2A");
            return View(model);
        }
        [HttpPost]
        public IActionResult StudentsContactInformation(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllStudentsContanctInfoForList(pageSize, pageNo.Value, "2A");
            return View(model);
        }
        [HttpGet]
        public IActionResult StudentsAvarages()
        {
            var model = _studentsService.GetAllAvarageGradesForList(10, 1, "2A");
            return View(model);
        }
        [HttpPost]
        public IActionResult StudentsAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllAvarageGradesForList(pageSize, pageNo.Value, "2A");
            return View(model);
        }
        [HttpGet]
        public IActionResult BiologyAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2A",1);
            return View(model);
        }
        [HttpPost]
        public IActionResult BiologyAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2A",1);
            return View(model);
        }
        [HttpGet]
        public IActionResult ChemistryAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2A", 2);
            return View(model);
        }
        [HttpPost]
        public IActionResult ChemistryAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2A", 2);
            return View(model);
        }
        [HttpGet]
        public IActionResult EnglishAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2A", 3);
            return View(model);
        }
        [HttpPost]
        public IActionResult EnglishAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2A", 3);
            return View(model);
        }
        [HttpGet]
        public IActionResult GeographyAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2A", 4);
            return View(model);
        }
        [HttpPost]
        public IActionResult GeographyAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2A", 4);
            return View(model);
        }
        [HttpGet]
        public IActionResult GermanAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2A", 5);
            return View(model);
        }
        [HttpPost]
        public IActionResult GermanAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2A", 5);
            return View(model);
        }
        [HttpGet]
        public IActionResult HistoryAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2A", 6);
            return View(model);
        }
        [HttpPost]
        public IActionResult HistoryAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2A", 6);
            return View(model);
        }
        [HttpGet]
        public IActionResult MathAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "2A", 7);
            return View(model);
        }
        [HttpPost]
        public IActionResult MathAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "2A", 7);
            return View(model);
        }
