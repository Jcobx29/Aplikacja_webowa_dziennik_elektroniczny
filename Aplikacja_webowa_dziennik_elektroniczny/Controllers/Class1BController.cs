...
{
    [Authorize(Roles = "Student1B, BiologyTeacher, ChemistryTeacher, EnglishTeacher, GeographyTeacher, GermanTeacher, HistoryTeacher, MathTeacher, HeadTeacher")]
    public class Class1BController : Controller
    {
        ...
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "1B", 1);
            return View(model);
        }
        [HttpPost]
        public IActionResult BiologyAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "1B", 1);
            return View(model);
        }
        [HttpGet]
        public IActionResult ChemistryAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "1B", 2);
            return View(model);
        }
        [HttpPost]
        public IActionResult ChemistryAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "1B",2 );
            return View(model);
        }
        [HttpGet]
        public IActionResult EnglishAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "1B", 3);
            return View(model);
        }
        [HttpPost]
        public IActionResult EnglishAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "1B", 3);
            return View(model);
        }
        [HttpGet]
        public IActionResult GeographyAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "1B", 4);
            return View(model);
        }
        [HttpPost]
        public IActionResult GeographyAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "1B", 4);
            return View(model);
        }
        [HttpGet]
        public IActionResult GermanAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "1B", 5);
            return View(model);
        }
        [HttpPost]
        public IActionResult GermanAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "1B", 5);
            return View(model);
        }
        [HttpGet]
        public IActionResult HistoryAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "1B", 6);
            return View(model);
        }
        [HttpPost]
        public IActionResult HistoryAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "1B", 6);
            return View(model);
        }
        [HttpGet]
        public IActionResult MathAvarages()
        {
            var model = _studentsService.GetAllGradesForList(10, 1, "1B", 7);
            return View(model);
        }
        [HttpPost]
        public IActionResult MathAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGradesForList(pageSize, pageNo.Value, "1B", 7);
            return View(model);
        }
