...
namespace Aplikacja_webowa_dziennik_elektroniczny.Controllers
{
    public class Class2CController : Controller
    {
        ...
        public Class2CController(IStudentsService studentsService)
        {
        ...
        {
            var model = _studentsService.GetAllStudentsForList(10, 1, "2C");
            return View(model);
        }
        [HttpPost]
        public IActionResult Index(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllStudentsForList(pageSize, pageNo.Value, "2C");
            return View(model);
        }
        [HttpGet]
        public IActionResult StudentsContactInformation()
        {
            var model = _studentsService.GetAllStudentsContanctInfoForList(10, 1, "2C");
            return View(model);
        }
        [HttpPost]
        public IActionResult StudentsContactInformation(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllStudentsContanctInfoForList(pageSize, pageNo.Value, "2C");
            return View(model);
        }
        [HttpGet]
        public IActionResult StudentsAvarages()
        {
            var model = _studentsService.GetAllAvarageGradesForList(10, 1, "2C");
            return View(model);
        }
        [HttpPost]
        public IActionResult StudentsAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllAvarageGradesForList(pageSize, pageNo.Value, "2C");
            return View(model);
        }
        [HttpGet]
        public IActionResult BiologyAvarages()
        {
            var model = _studentsService.GetAllBiologyForList(10, 1, "2C");
            return View(model);
        }
        [HttpPost]
        public IActionResult BiologyAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllBiologyForList(pageSize, pageNo.Value, "2C");
            return View(model);
        }
        [HttpGet]
        public IActionResult ChemistryAvarages()
        {
            var model = _studentsService.GetAllChemistryForList(10, 1, "2C");
            return View(model);
        }
        [HttpPost]
        public IActionResult ChemistryAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllChemistryForList(pageSize, pageNo.Value, "2C");
            return View(model);
        }
        [HttpGet]
        public IActionResult EnglishAvarages()
        {
            var model = _studentsService.GetAllEnglishForList(10, 1, "2C");
            return View(model);
        }
        [HttpPost]
        public IActionResult EnglishAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllEnglishForList(pageSize, pageNo.Value, "2C");
            return View(model);
        }
        [HttpGet]
        public IActionResult GeographyAvarages()
        {
            var model = _studentsService.GetAllGeographyForList(10, 1, "2C");
            return View(model);
        }
        [HttpPost]
        public IActionResult GeographyAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGeographyForList(pageSize, pageNo.Value, "2C");
            return View(model);
        }
        [HttpGet]
        public IActionResult GermanAvarages()
        {
            var model = _studentsService.GetAllGermanForList(10, 1, "2C");
            return View(model);
        }
        [HttpPost]
        public IActionResult GermanAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGermanForList(pageSize, pageNo.Value, "2C");
            return View(model);
        }
        [HttpGet]
        public IActionResult HistoryAvarages()
        {
            var model = _studentsService.GetAllHistoryForList(10, 1, "2C");
            return View(model);
        }
        [HttpPost]
        public IActionResult HistoryAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllHistoryForList(pageSize, pageNo.Value, "2C");
            return View(model);
        }
        [HttpGet]
        public IActionResult MathAvarages()
        {
            var model = _studentsService.GetAllMathForList(10, 1, "2C");
            return View(model);
        }
        [HttpPost]
        public IActionResult MathAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllMathForList(pageSize, pageNo.Value, "2C");
            return View(model);
        }
