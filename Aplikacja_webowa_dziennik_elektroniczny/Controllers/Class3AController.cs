...
namespace Aplikacja_webowa_dziennik_elektroniczny.Controllers
{
    public class Class3AController : Controller
    {
        ...
        {
            var model = _studentsService.GetAllBiologyForList(10, 1, "3A");
            return View(model);
        }
        [HttpPost]
        public IActionResult BiologyAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllBiologyForList(pageSize, pageNo.Value, "3A");
            return View(model);
        }
        [HttpGet]
        public IActionResult ChemistryAvarages()
        {
            var model = _studentsService.GetAllChemistryForList(10, 1, "3A");
            return View(model);
        }
        [HttpPost]
        public IActionResult ChemistryAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllChemistryForList(pageSize, pageNo.Value, "3A");
            return View(model);
        }
        [HttpGet]
        public IActionResult EnglishAvarages()
        {
            var model = _studentsService.GetAllEnglishForList(10, 1, "3A");
            return View(model);
        }
        [HttpPost]
        public IActionResult EnglishAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllEnglishForList(pageSize, pageNo.Value, "3A");
            return View(model);
        }
        [HttpGet]
        public IActionResult GeographyAvarages()
        {
            var model = _studentsService.GetAllGeographyForList(10, 1, "3A");
            return View(model);
        }
        [HttpPost]
        public IActionResult GeographyAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGeographyForList(pageSize, pageNo.Value, "3A");
            return View(model);
        }
        [HttpGet]
        public IActionResult GermanAvarages()
        {
            var model = _studentsService.GetAllGermanForList(10, 1, "3A");
            return View(model);
        }
        [HttpPost]
        public IActionResult GermanAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllGermanForList(pageSize, pageNo.Value, "3A");
            return View(model);
        }
        [HttpGet]
        public IActionResult HistoryAvarages()
        {
            var model = _studentsService.GetAllHistoryForList(10, 1, "3A");
            return View(model);
        }
        [HttpPost]
        public IActionResult HistoryAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllHistoryForList(pageSize, pageNo.Value, "3A");
            return View(model);
        }
        [HttpGet]
        public IActionResult MathAvarages()
        {
            var model = _studentsService.GetAllMathForList(10, 1, "3A");
            return View(model);
        }
        [HttpPost]
        public IActionResult MathAvarages(int pageSize, int? pageNo)
        {
            ...
            var model = _studentsService.GetAllMathForList(pageSize, pageNo.Value, "3A");
            return View(model);
        }
